                ...
                <div class="flex flex-row flex-wrap box-one">
                    ...
                    <article class="flex-shrink w-full max-w-full sm:w-1/2">
                        <div class="relative overflow-hidden border rounded opacity-30 hover-img max-h-98 hover:opacity-100 max-h-48">
                            ...
                            <div class="absolute bottom-0 w-full px-4 pb-4 bg-purple-400/60 pt-7 bg-gradient-cover">
                                <a href="#">
                                    <h2 class="mb-1 text-lg font-bold leading-tight text-white capitalize">{{ $moto->marca }}{{ $moto->modelo }}</h2>
                                </a>
                                <div class="pt-1">
                                    <div class="text-gray-100">
                                        <div class="inline-block h-3 mr-2 border-l-2 border-red-600"></div>{{ $moto->caballos }} CV
                                    </div>
                                </div>
                            </div>
                        </div>
